...
public class ArabicStemmerDefault{
    
    // for the get_root function
    private static Vector staticFiles ;
    static String  pathToStemmerFiles = new StringBuffer ( System.getProperty ( "user.dir" ) + System.getProperty ( "file.separator" ) + "\\src\\assets\\StemmerFiles" + System.getProperty ( "file.separator" ) ).toString ( );
